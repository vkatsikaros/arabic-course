...
afternoon        & \ar{ بَعد الظُّهر } \\
in the night     & \ar{ لّيل } \\
διασκεδαστικό, fun   & \ar{ مُمتِع } \\
αγαπώ \vr            & \ar{ ــ ، أُحِبُّ } \\  % shadda ok
τρώω  \vrf           & \ar{ أكَلَ ، يأكُلُ } \vrform{1} \\
κοιμάμαι \vrf   & \ar{ نامَ ، نِمتُ ، يَنامُ } \vrform{1} \\
το να κοιμάμαι \mas      & \ar{ نَوم } \\
μαγειρέυω \vrf       & \ar{ طَبَخَ ، يَطبُخُ } \\
γελώ \vrf            & \ar{ يبتسم ،اِبتَسَمتَ } \vrform{8} \\
...
ψάρι                 & \ar{ سَمَك } \\
ρολόι, ώρα            & \ar{ ساعة } \\
τί ώρα είναι;        & \ar{ كَم الساعة؟ } \\
μετά/after           & \ar{ بَعدَ } \\
απασχολημένος/busy   & \ar{ مَشغول } \\
